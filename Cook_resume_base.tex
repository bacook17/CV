...
\begin{easylist} \mysubsections
  ...
  && \itemdate{Ph.D.~Astronomy and Astrophysics}{Expected 2019}
...
\mysection{Relevant Experience}
\begin{easylist} \mybullets
  %& \itemdate{\textbf{DE Shaw Company}}{New York, NY}
  ...
  &&&  Accelerated simulation code by 16x with GPU-acceleration
  ...
  ($>10$TB) dataset from cosmological simulation of galaxies
...
\twopageonly{
\mysection{Selected Contributed and Public Talks (3 of 6)}
\begin{easylist}  \mysubsections}
\twopageonly{
